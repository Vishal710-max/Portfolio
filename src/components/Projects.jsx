...
const projects = [
  {
    ...
    description:
      "A responsive task scheduler that lets users create, update, and organize tasks efficiently Uses React and local storage to ensure seamless state management and data persistence.",
  ...
  },
  {
    ...
    description:
      "An AI-powered resume analysis platform that evaluates resumes, identifies skill gaps, and matches candidates with relevant job roles using NLP.",
  ...
  },
  {
    ...
    description:
      "A secure password management application with encrypted data storage Built using Python and Streamlit with a focus on usability and security best practices.",
  ...
  },
  {
    ...
    description:
      "A simple and efficient contact management system with full CRUD functionality Developed using Python, MySQL, and Streamlit for structured data handling.",
